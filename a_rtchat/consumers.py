...
class OnlineStatusConsumer(WebsocketConsumer):
    def connect(self):
        ...
        # Try to get the group, create if it does not exist
    ...
    def online_status_handler(self, event):
        ...
        group_chats_with_users = [chat for chat in my_chats.filter(group_name__isnull=False) if chat.users_online.exclude(id=self.user.id)]
        
        online_in_chats = public_chat_users or private_chats_with_users or group_chats_with_users
